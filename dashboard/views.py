...
def dashboardPage(request):
    ...
    if get_auth.dashboard:
        ...
        for xml_data in get_data_from_crvs:
            ...
            # get_data_based_on_region
            get_region = soup.find('Id10005R').text
            # compare_with_logged_in_user_region
            if get_user_region == get_region:
                get_region = soup.find('Id10005R').text
        ...
        my_region_ = []
        va_count = 0
        for region_data in get_regions_as_tab:
            get_my_region = region_data['get_region']
            va_count = get_region_.count(get_my_region)
            region_dict = {
                'Region': get_my_region,
                'VA': va_count
            }
            my_region_.append(region_dict)
            my_region.append(region_data['get_region'])

        df = pd.DataFrame(my_region_)
        fig = px.bar(
            df,
            x = 'Region',
            y = 'VA',
            title = "VA Records Entered",
            labels = {'x':'Region', 'y':'Number of VA'},
    ...
    if get_auth.va_record:
        ...
        for xml_data in get_data_from_crvs:
            ...
            if get_user_region == get_region:
                ...
                get_interviwer_age = soup.find('Id10010a').text
                get_interviwer_sex = soup.find('Id10010b').text
                ...
                try:
                    ...
                    get_when_did_she_or_he_die_a = "None"

                try:
                    get_when_did_she_or_he_die_b = soup.find('Id10023_b').text
                except:
                    get_when_did_she_or_he_die_b = "None"

                try:
                    get_when_did_she_or_he_die = soup.find('Id10023_b').text
                except:
                    get_when_did_she_or_he_die = "None"

                try:
                    get_please_indicate_the_year_of_death = soup.find('Id10024').text
                except:
                    get_please_indicate_the_year_of_death = "None"

                #

                try:
                    get_where_did_the_deceased_die  = soup.find('Id10058').text
                except:
                    get_where_did_the_deceased_die = "None"

                try:
                    get_name_of_the_hospital_or_health_facility_where_death_occurred  = soup.find('Id10058name').text
                except:
                    get_name_of_the_hospital_or_health_facility_where_death_occurred = "None"

                try:
                    get_name_of_the_hospital_or_health_facility_where_death_occurred_other = soup.find('Id10058Other').text
                except:
                    get_name_of_the_hospital_or_health_facility_where_death_occurred_other = "None"

                try:
                    get_was_the_deceased_body_taken_to_hospital_or_health_facility_for_storage_before_burial = soup.find('Id10058b').text
                except:
                    get_was_the_deceased_body_taken_to_hospital_or_health_facility_for_storage_before_burial = "None"

                try:
                     get_which_hospital_or_health_facility_was_the_body_taken = soup.find('Id10058c').text
                except:
                    get_which_hospital_or_health_facility_was_the_body_taken = "None"

                try:
                     get_in_the_two_weeks_before_death_did_she_or_he_live_with_visit_or_care_for_someone_who_had_any_COVID19_symptoms_or_a_positive_COVID19_test= soup.find('Id10487').text
                except:
                    get_in_the_two_weeks_before_death_did_she_or_he_live_with_visit_or_care_for_someone_who_had_any_COVID19_symptoms_or_a_positive_COVID19_test = "None"

                try:
                     get_in_the_two_weeks_before_death_did_she_or_he_travel_to_an_area_where_COVID19_is_known_to_be_present = soup.find('Id10488').text
                except:
                    get_in_the_two_weeks_before_death_did_she_or_he_travel_to_an_area_where_COVID19_is_known_to_be_present = "None"

                try:
                     get_write_the_name_of_the_places_where_the_deceased_visited_in_the_last_two_weeks = soup.find('Id10488a').text
                except:
                    get_write_the_name_of_the_places_where_the_deceased_visited_in_the_last_two_weeks = "None"

                try:
                     get_is_there_a_need_to_collect_additional_demographic_data_on_the_deceased = soup.find('Id10051').text
                except:
                    get_is_there_a_need_to_collect_additional_demographic_data_on_the_deceased = "None"

                try:
                     get_what_was_her_his_citizenship_nationality = soup.find('Id10052').text
                except:
                    get_what_was_her_his_citizenship_nationality = "None"

                try:
                     get_what_was_her_his_ethnicity = soup.find('Id10053').text
                except:
                    get_what_was_her_his_ethnicity = "None"

                try:
                     get_region_of_birth = soup.find('Id10054R').text
                except:
                    get_region_of_birth = "None"

                try:
                     get_district_of_birth = soup.find('Id10054D').text
                except:
                    get_district_of_birth = "None"

                try:
                    get_other_district = soup.find('Id10054D_other').text
                except:
                    get_other_district = "None"

                try:
                    get_shehia_where_this_interview_is_happening = soup.find('Id10054S').text
                except:
                    get_shehia_where_this_interview_is_happening = "None"

                try:
                    get_village_of_birth = soup.find('Id10054V').text
                except:
                    get_village_of_birth = "None"

                try:
                    get_what_was_her_his_place_of_usual_residence_the_place_where_the_person_lived_most_of_the_year = soup.find('Id10055').text
                except:
                    get_what_was_her_his_place_of_usual_residence_the_place_where_the_person_lived_most_of_the_year = "None"

                try:
                    get_where_did_the_death_occur = soup.find('Id10057').text
                except:
                    get_where_did_the_death_occur = "None"

                try:
                    get_region_where_death_occurred = soup.find('Id10057R').text
                except:
                    get_region_where_death_occurred = "None"

                try:
                    get_disrtrict_where_death_occurred = soup.find('Id10057D').text
                except:
                    get_disrtrict_where_death_occurred = "None"

                try:
                    get_other_district = soup.find('Id10057D_other').text
                except:
                    get_other_district = "None"

                try:
                    get_shehia_where_this_interview_is_happening = soup.find('Id10057S').text
                except:
                    get_shehia_where_this_interview_is_happening = "None"

                try:
                    get_village = soup.find('Id10057V').text
                except:
                    get_village = "None"

                try:
                    get_if_death_occurred_outside_the_country_please_specify_the_place = soup.find('Id10057_death_outside').text
                except:
                    get_if_death_occurred_outside_the_country_please_specify_the_place = "None"

                try:
                    get_what_was_her_his_marital_status = soup.find('Id10059').text
                except:
                    get_what_was_her_his_marital_status = "None"

                try:
                    get_is_the_date_of_marriage_available = soup.find('Id10060_check').text
                except:
                    get_is_the_date_of_marriage_available = "None"

                try:
                    get_what_was_the_date_of_marriage = soup.find('Id10060').text
                except:
                    get_what_was_the_date_of_marriage = "None"

                try:
                    get_what_was_the_name_of_the_father = soup.find('Id10061').text
                except:
                    get_what_was_the_name_of_the_father = "None"

                try:
                    get_what_was_the_name_of_the_mother = soup.find('Id10062').text
                except:
                    get_what_was_the_name_of_the_mother = "None"

                try:
                    get_what_was_her_his_highest_level_of_schooling = soup.find('Id10063').text
                except:
                    get_what_was_her_his_highest_level_of_schooling = "None"

                try:
                    get_was_the_able_to_read_and_or_write = soup.find('Id10064').text
                except:
                    get_was_the_able_to_read_and_or_write = "None"
                ...
                try:
                    get_what_was_her_his_economic_activity_status_in_year_prior_to_death = soup.find('Id10065').text
                except:
                    get_what_was_her_his_economic_activity_status_in_year_prior_to_death = "None"

                try:
                    get_what_was_her_his_occupation_that_is_what_kind_of_work_did_she_or_he_mainly_do = soup.find('Id10066ss').text
                except:
                    get_what_was_her_his_occupation_that_is_what_kind_of_work_did_she_or_he_mainly_do = "None"
                ...
                try:
                  get_was_an_hiV_test_ever_positive = soup.find('id10126')
                except:
                ...
                my_data_dict = {
                    ...
                    'get_interviwer_age': get_interviwer_age,
                    'get_interviwer_sex': get_interviwer_sex,
                    ...
                    'get_other_district': get_other_district,
                    'get_ward_where_this_interview_happening': get_ward_where_this_interview_happening,
                    'get_shehia_where_this_interview_happening': get_shehia_where_this_interview_happening,
                    'get_village_street_where_this_interview_happening': get_village_street_where_this_interview_happening,
                    'get_vrespondent_relationship_to_the_deceased': get_vrespondent_relationship_to_the_deceased,
                    'get_respondent_live_with_the_deceased_in_the_period_leading_to_her_his_death': get_respondent_live_with_the_deceased_in_the_period_leading_to_her_his_death,
                    'get_did_respondent_give_consent': get_did_respondent_give_consent,
                    'get_what_was_the_first_or_given_name_of_the_deceased': get_what_was_the_first_or_given_name_of_the_deceased,
                    'get_what_was_the_surname_or_famil_name_of_the_deceased': get_what_was_the_surname_or_famil_name_of_the_deceased,
                    'get_what_was_sex_of_the_deceased': get_what_was_sex_of_the_deceased,
                    'get_is_the_date_of_birth_known': get_is_the_date_of_birth_known,
                    'get_when_was_the_deceased_born': get_when_was_the_deceased_born,
                    'get_is_the_date_of_death_known': get_is_the_date_of_death_known,
                    'get_when_did_she_or_he_die_a': get_when_did_she_or_he_die_a,
                    'get_when_did_she_or_he_die_b': get_when_did_she_or_he_die_b,
                    'get_when_did_she_or_he_die': get_when_did_she_or_he_die,
                    'get_please_indicate_the_year_of_death': get_please_indicate_the_year_of_death,
                    'get_where_did_the_deceased_die': get_where_did_the_deceased_die,
                    'get_name_of_the_hospital_or_health_facility_where_death_occurred': get_name_of_the_hospital_or_health_facility_where_death_occurred,
                    'get_name_of_the_hospital_or_health_facility_where_death_occurred_other': get_name_of_the_hospital_or_health_facility_where_death_occurred_other,
                    'get_was_the_deceased_body_taken_to_hospital_or_health_facility_for_storage_before_burial': get_was_the_deceased_body_taken_to_hospital_or_health_facility_for_storage_before_burial,
                    'get_which_hospital_or_health_facility_was_the_body_taken': get_which_hospital_or_health_facility_was_the_body_taken,
                    'get_in_the_two_weeks_before_death_did_she_or_he_live_with_visit_or_care_for_someone_who_had_any_COVID19_symptoms_or_a_positive_COVID19_test': get_in_the_two_weeks_before_death_did_she_or_he_live_with_visit_or_care_for_someone_who_had_any_COVID19_symptoms_or_a_positive_COVID19_test,
                    'get_in_the_two_weeks_before_death_did_she_or_he_travel_to_an_area_where_COVID19_is_known_to_be_present': get_in_the_two_weeks_before_death_did_she_or_he_travel_to_an_area_where_COVID19_is_known_to_be_present,
                    'get_write_the_name_of_the_places_where_the_deceased_visited_in_the_last_two_weeks': get_write_the_name_of_the_places_where_the_deceased_visited_in_the_last_two_weeks,
                    'get_is_there_a_need_to_collect_additional_demographic_data_on_the_deceased': get_is_there_a_need_to_collect_additional_demographic_data_on_the_deceased,
                    'get_what_was_her_his_citizenship_nationality': get_what_was_her_his_citizenship_nationality,
                    'get_what_was_her_his_ethnicity': get_what_was_her_his_ethnicity,
                    'get_region_of_birth': get_region_of_birth,
                    'get_district_of_birth': get_district_of_birth,
                    'get_other_district': get_other_district,
                    'get_shehia_where_this_interview_is_happening': get_shehia_where_this_interview_is_happening,
                    'get_village_of_birth': get_village_of_birth,
                    'get_what_was_her_his_place_of_usual_residence_the_place_where_the_person_lived_most_of_the_year': get_what_was_her_his_place_of_usual_residence_the_place_where_the_person_lived_most_of_the_year,
                    'get_where_did_the_death_occur': get_where_did_the_death_occur,
                    'get_region_where_death_occurred': get_region_where_death_occurred,
                    'get_disrtrict_where_death_occurred': get_disrtrict_where_death_occurred,
                    'get_other_district': get_other_district,
                    'get_shehia_where_this_interview_is_happening': get_shehia_where_this_interview_is_happening,
                    'get_village': get_village,
                    'get_if_death_occurred_outside_the_country_please_specify_the_place': get_if_death_occurred_outside_the_country_please_specify_the_place,
                    'get_what_was_her_his_marital_status': get_what_was_her_his_marital_status,
                    'get_is_the_date_of_marriage_available': get_is_the_date_of_marriage_available,
                    'get_what_was_the_date_of_marriage': get_what_was_the_date_of_marriage,
                    'get_what_was_the_name_of_the_father': get_what_was_the_name_of_the_father,
                    'get_what_was_the_name_of_the_mother': get_what_was_the_name_of_the_mother,
                    'get_what_was_her_his_highest_level_of_schooling': get_what_was_her_his_highest_level_of_schooling,
                    'get_was_the_able_to_read_and_or_write': get_was_the_able_to_read_and_or_write,
                    'get_what_was_her_his_economic_activity_status_in_year_prior_to_death': get_what_was_her_his_economic_activity_status_in_year_prior_to_death,
                    'get_what_was_her_his_occupation_that_is_what_kind_of_work_did_she_or_he_mainly_do': get_what_was_her_his_occupation_that_is_what_kind_of_work_did_she_or_he_mainly_do,
